...
if __name__ == "__main__":
    ...
    rec2=30
    packets.append(AllocateGranule(index=rec2))
    packets.append(GranuleDelegate(index=rec2))
    packets.append(RecCreate(
        rd_index=rd,
        rec_index=rec2,
        param_index=rec_params,
    ...
    packets.append(PsciComplete(calling_rec=rec, target_rec=rec2,
                                status=1))
    ...
    packets.append(SroContinue(flags=0))
    packets.append(RecDestroy(rec_index=rec2))
    packets.append(SroReclaim(list_entries=255))
    packets.append(SroContinue(flags=0))
