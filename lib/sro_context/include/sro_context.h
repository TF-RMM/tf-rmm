...
struct sro_unmap_ctx {
	...
	long leaf_level;
	/*
	 * Per-SMMU CMD_SYNC completion words. Each array element is the target
	 * of an MSI write generated by the corresponding SMMU when a CMD_SYNC
	 * operation completes, allowing software to poll for completion without
	 * waiting for an interrupt.
	 */
	unsigned int msi_addr[RMM_MAX_SMMUS];
};
