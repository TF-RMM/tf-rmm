...
TEST(s2tt_non_lpa2, s2tt_invalidate_page_tc1)
{
	s2tt_invalidate_page_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_invalidate_page_tc2)
{
	s2tt_invalidate_page_tc2();
}

TEST(s2tt_non_lpa2, s2tt_invalidate_block_tc1)
{
	s2tt_invalidate_block_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_invalidate_block_tc2)
{
	s2tt_invalidate_block_tc2();
}

TEST(s2tt_non_lpa2, s2tt_invalidate_pages_in_block_tc1)
{
	s2tt_invalidate_pages_in_block_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_invalidate_pages_in_block_tc2)
{
