...
COMPILER_ASSERT(U(offsetof(struct rsi_plane_enter, elr_el1)) == 0x400U);
...
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, elr_el2)) == 0x8U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, pstate)) == 0x10U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, gprs)) == 0x100U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, esr_el2)) == 0x200U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, far_el2)) == 0x208U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, hpfar_el2)) == 0x210U);
...
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, sctlr_el1)) == 0x500U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, vbar_el1)) == 0x508U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, elr_el1)) == 0x510U);
COMPILER_ASSERT(U(offsetof(struct rsi_plane_exit, pmu_ovf_status)) == 0x600U);
