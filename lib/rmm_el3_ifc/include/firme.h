...
#define SMC_FIRME_BASE_VERSION		SMC64_STD_FID(FIRME, U(0))
#define SMC_FIRME_BASE_FEATURES		SMC64_STD_FID(FIRME, U(1))
#define SMC_FIRME_GM_GPI_SET		SMC64_STD_FID(FIRME, U(2))
...
#define FIRME_SERVICE_ID_MAX			U(6)

/* Base feature register definitions. */
#define FIRME_BASE_FR1_GM_SVC_BIT		UL(0x1UL << 16)

/* GM service feature register definitions */
#define FIRME_GM_FRO_GPI_SET_BIT		UL(0x1)
