...
#define SMC_RMM_EL3_TOKEN_SIGN		SMC64_STD_FID(RMM_EL3, U(5))
					...
					/* 0x1B6 */
#define SMC_RMM_MECID_UPDATE		SMC64_STD_FID(RMM_EL3, U(6))
...
/*
 * Update key corresponding to the given MECID.
 *
 * Args:
 ...
 */
static inline unsigned long rmm_el3_ifc_mecid_update(unsigned short mecid)
{
	return monitor_call(SMC_RMM_MECID_UPDATE, mecid,
				0UL, 0UL, 0UL, 0UL, 0UL);
}
