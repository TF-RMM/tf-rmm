...
DEFINE_SYSREG_RW_FUNCS(mpamidr_el1)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(tcr2_el12, TCR2_EL12);
...
/* FEAT_S1PIE & FEAT_S1POE 2022 Architecture Extensions */
DEFINE_RENAME_SYSREG_RW_FUNCS(pir_el12, PIR_EL12)
DEFINE_RENAME_SYSREG_RW_FUNCS(por_el12, POR_EL12)
DEFINE_RENAME_SYSREG_RW_FUNCS(pire0_el12, PIRE0_EL12)

/* FEAT_S2PIE & FEAT_S2POE 2022 Architecture Extensions */
...
DEFINE_RENAME_SYSREG_RW_FUNCS(mecid_a0_el2, MECID_A0_EL2)

DEFINE_RENAME_SYSREG_RW_FUNCS(mecid_p1_el2, MECID_P1_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(mecid_a1_el2, MECID_A1_EL2)

DEFINE_RENAME_SYSREG_RW_FUNCS(vmecid_p_el2, VMECID_P_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(vmecid_a_el2, VMECID_A_EL2)

/* FEAT_SCTLR2 Register */
