...
#define APP_YIELD_CALL		UL(24)
#define APP_SERVICE_CALL	UL(47)

#define APP_SERVICE_PRINT				 0U
#define APP_SERVICE_RANDOM				 1U
#define APP_SERVICE_GET_REALM_ATTESTATION_KEY		 2U
#define APP_SERVICE_GET_PLATFORM_TOKEN			 3U
#define APP_SERVICE_GET_REALM_ATTEST_PUB_KEY_FROM_EL3	 4U
#define APP_SERVICE_EL3_TOKEN_SIGN_QUEUE_TRY_ENQUEUE	 5U
#define APP_SERVICE_EL3_IFC_EL3_TOKEN_SIGN_SUPPORTED	 6U
#define APP_SERVICE_WRITE_TO_NS_BUF			 7U
#define APP_SERVICE_READ_FROM_NS_BUF_ALIGNED		 8U
#define APP_SERVICE_RP_IDE_KEY_PROGRAM			 9U
#define APP_SERVICE_RP_IDE_KEY_SET_GO			10U
#define APP_SERVICE_RP_IDE_KEY_SET_STOP			11U
#define APP_SERVICE_NS_MMIO_READ_4			12U
#define APP_SERVICE_REALM_MMIO_WRITE_4			13U
#define APP_SERVICE_COUNT				14U
