...
.. csv-table:: RMM CMake Options Table
   ...
   HOST_VARIANT			,host_build | host_test | host_cbmc | host_fuzz ,host_build	,"Variant to build for the host platform. Only available when RMM_PLATFORM=host"
   ...
   RMM_SANITIZERS		,ALL | UBSAN | IOSAN | ICSAN | LBSAN | NGSAN	,			,"Sanitizers to enable for the build. ALL enables all sanitizers. IOSAN, ICSAN, LBSAN and NGSAN are LLVM-only."
